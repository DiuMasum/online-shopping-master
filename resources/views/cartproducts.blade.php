					...
					<tbody>
                        ...
                        @foreach($cartItems->items as $item)
							<td class="cart_product">
								<a href=""><img src="images/{{$item['data']['image']}}"></a>
							</td>
							...
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="deleteItemFromCart/{{$item['data']['id']}}"><i class="fa fa-times"></i></a>
							</td>
						</tr>
				...
				<div class="col-sm-6">
					<div class="total_area">
                        ...
                        <li>Total <span>{{$cartItems->totalPrice}}</span></li>
							...
							<a class="btn btn-default check_out" href="/checkoutProducts">Check Out</a>
					</div>
				</div>
			</div>
		</div>
